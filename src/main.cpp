 ...
 */
 ...
 void ajukanPermohonanPerubahanData(int nis);
void menu(bool &menuAdminStat, bool &menuLoginStat, int usernameIn)
{
    // Menu Admin
    ...
    else
    {
        ...
        while (menuLoginStat == true)
        {
            ...
            {
            case 1:
                displayBiodata(usernameIn);
                break;
            case 2:
                ajukanPermohonanPerubahanData(usernameIn);
                break;
            case 0:
                menuLoginStat = false;
                break;
            ...
            if (decision == 1){
                ...
                if (idx != -1)
                {
                    ...
                    } else if (dataAcc[i].kelas == dataPermohonan[i].dataLama)
                    {
                     ...
                     // tolong di cek logicnya dong, pusing liatnya :"v
                    if (cocok)
                    {
...
void displayBiodata(int nis){
    importDataTxt(pathDbDefault, 1);

    int idx = binarySearchRecursive(dataAcc, 0, jumlahAcc - 1, nis);
    if (idx == -1)
    {
